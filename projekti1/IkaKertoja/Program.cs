internal class Program
{
    private static void Main(string[] args)
    {
        ...
        if (x < 18) //Tässä määritämme että jos käyttäjä syöttää alle 18 niin ohjelma kertoo käyttäjän olevan alaikäinen 
        {
            Console.WriteLine(x + " olet alaikäinen.");
        }
        else //Tässä ohjelma kertoo yli 18 annetuilla luvuilla käyttäjän olevan täysi-ikäinen
        {
