namespace RoomalaisetNro
{
    public partial class Form1 : Form
    {
        ...
        private void muutaBT_Click(object sender, EventArgs e)
        {
            ...
            string vastaus = "";
            if (nroTB.Text.Length > 3) //Tuhatluku
            {
                luku1 = Convert.ToInt32(nroTB.Text.Substring(0, 1)); //Tuhannet
                luku2 = Convert.ToInt32(nroTB.Text.Substring(1, 1)); //Sadat
                luku3 = Convert.ToInt32(nroTB.Text.Substring(2, 1)); //Kympit
                luku4 = Convert.ToInt32(nroTB.Text.Substring(3, 1)); //Ykköset
                if (luku1 % 3 == 0)
                {
                    vastaus += "MMM";
                }
            ...
            else if (nroTB.Text.Length > 2) //Sataluku
            {
                luku2 = Convert.ToInt32(nroTB.Text.Substring(0, 1));
                luku3 = Convert.ToInt32(nroTB.Text.Substring(1, 1));
                luku4 = Convert.ToInt32(nroTB.Text.Substring(2, 1));
                vastaus += sataset(luku2, vastaus);
                vastaus += kympit(luku3, vastaus);
                vastaus += ykkoset(luku4, vastaus);
            }
            else if (nroTB.Text.Length > 1) //Kymmenluku
            {
                luku3 = Convert.ToInt32(nroTB.Text.Substring(0, 1));
                luku4 = Convert.ToInt32(nroTB.Text.Substring(1, 1));
                vastaus += kympit(luku3, vastaus);
                vastaus += ykkoset(luku4, vastaus);
            }
            else if (nroTB.Text.Length > 0)
            {
                luku4 = Convert.ToInt32(nroTB.Text.Substring(0, 1));
                vastaus += ykkoset(luku4, vastaus);
            }
